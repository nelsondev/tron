...
public class YamlData {
     ...
     */
    public YamlData(JavaPlugin main, Player player) {
        this.file = new File(main.getDataFolder() + "/playerData/" + player.getUniqueId() + ".yml");
        this.data = YamlConfiguration.loadConfiguration(file);
    }

    public YamlData(JavaPlugin main, UUID uniqueId) {
        this.file = new File(main.getDataFolder() + "/playerData/" + uniqueId + ".yml");
        this.data = YamlConfiguration.loadConfiguration(file);
    }

    public YamlData(JavaPlugin main, String path, String fileName) {
        this.file = new File(main.getDataFolder() + "/" + path + "/" + fileName + ".yml");
        this.data = YamlConfiguration.loadConfiguration(file);
    }

    public YamlData(JavaPlugin main, String fileName) {
        this.file = new File(main.getDataFolder() + "/" + fileName + ".yml");
        this.data = YamlConfiguration.loadConfiguration(file);
    }
